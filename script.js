...
╚═╝     ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝ ╚═════╝ `;
    ...
    const welcome =
      ...
      this.wrapWithColor(
        "           El Yazid Hammoubel - Interactive Terminal\n",
        "#888888"
      ) +
      this.wrapWithColor(
        "     Software Engineer • Full-Stack & Systems • Cybersecurity\n",
        "#666666"
      ) +
      this.wrapWithColor(divider + "\n\n", "#555555") +
...
${this.wrapWithColor("Hey there! 👋", "#ffffff")}

If you've stumbled across my portfolio, then you're probably a recruiter... or someone who somehow randomly typed ${this.wrapWithColor("hammoubelyazid.com", "#ffff00")} into their browser (which raises concerns). Either way, welcome! I think you're lucky to have found this little corner of the internet. 😉

I'm ${this.wrapWithColor("El Yazid — Yazid for short", "#00ffff")} — a Moroccan guy who's still trying to understand how humanity managed to build such an astonishing civilization. Out of everything we've created, ${this.wrapWithColor("computers fascinate me the most", "#98fb98")}.

I've had one since I was a kid, but back then I didn't care how it worked—as long as my games launched, I was happy. Then I grew up, took my first computer science classes, and something clicked. I stopped seeing computers as magical black boxes and started seeing them for what they really are: ${this.wrapWithColor("one of humanity's greatest engineering achievements", "#ffa07a")}.

The deeper I dive, the more I admire the generations of engineers, researchers, and curious minds who built the foundations we stand on today. Every abstraction I peel back only makes me appreciate the elegance hidden underneath.

That's why ${this.wrapWithColor("software engineering felt like the obvious path for me", "#ffff00")}. Not just because I enjoy writing code, but because I'm fascinated by the idea that, with nothing more than curiosity, a laptop, and a few lines of code, we can create things that millions of people use, remember, or simply enjoy.

So, enough about me—have a look around. I hope you enjoy exploring what I've been building as much as I've enjoyed building it.`;
...
<span style="color: #00ffff;">[COMPANY A] | Senior Software Engineer</span>
${this.wrapWithColor(
  "Jul 2022 - Present | San Francisco, USA",
  "#ffffff"
)}
${this.wrapWithColor(
  "Leading full-stack engineering initiatives and cloud systems",
  "#98fb98"
)}

• ${this.wrapWithColor("Tech Leadership", "#ffa07a")} - ${this.wrapWithColor(
      "Architeched microservices and mentored junior developers.",
      "#ffffff"
    )}
• ${this.wrapWithColor("Fullstack Code", "#ffa07a")} - ${this.wrapWithColor(
      "Wrote responsive frontend components and robust backend APIs.",
      "#ffffff"
    )}
...
<span style="color: #00ffff;">[COMPANY B] | Software Engineer</span>
${this.wrapWithColor(
  "Jan 2020 – Jun 2022 | London, UK",
  "#ffffff"
)}

• ${this.wrapWithColor("API Engineering", "#ffa07a")} - ${this.wrapWithColor(
      "Engineered high-throughput REST APIs and database schemas.",
      "#ffffff"
    )}
• ${this.wrapWithColor("Performance Optimization", "#ffa07a")} - ${this.wrapWithColor(
      "Improved system responsiveness and reduced query latency.",
      "#ffffff"
    )}

${this.wrapWithColor("Technologies used:", "#00ffff")} ${this.wrapWithColor(
      "JavaScript, Node.js, Express, MongoDB, Redis, Docker, Jest",
      "#87cefa"
    )}

<span style="color: #00ffff;">[COMPANY C] | Frontend Developer</span>
${this.wrapWithColor(
  "Sep 2018 – Dec 2019 | Berlin, Germany",
  "#ffffff"
)}

• ${this.wrapWithColor("UI Development", "#ffa07a")} - ${this.wrapWithColor(
      "Built intuitive interfaces and reusable component libraries.",
      "#ffffff"
    )}

${this.wrapWithColor("Technologies used:", "#00ffff")} ${this.wrapWithColor(
      "React, HTML5, CSS3, JavaScript, Webpack",
      "#87cefa"
    )}`;
...
${this.wrapWithColor(
  ...
  showSkills(outputElement = this.output) {
    const skills = `<span style="color: #ffff00; font-weight: bold;">🛠️ PROGRAMMING & SKILLS</span>
...
• ${this.wrapWithColor("AWS / Cloud", "#ffffff")}
...
${this.wrapWithColor("✉", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="mailto:your-email@example.com" style="color: #ffffff; text-decoration: none;">your-email@example.com</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("🌐", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://yourportfolio.com" target="_blank" style="color: #ffffff; text-decoration: none;">yourportfolio.com</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("⚡", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://github.com/[your-username]" target="_blank" style="color: #ffffff; text-decoration: none;">github.com/[your-username]</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("💼", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://linkedin.com/in/[your-username]" target="_blank" style="color: #ffffff; text-decoration: none;">linkedin.com/in/[your-username]</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("╰────────────────────────────────────────╯", "#ff8c00")}`;
  ...
  loadProjects() {
    this.projects = [
      {
        title: "Neuro-Mesh — Security Fabric P2P",
        description: "Pipeline de détection-isolation sub-100ms (kprobes eBPF, ONNX, XDP, nftables/iptables), protocole PBFT 6 étapes sur UDP unicast (Ed25519) et codebase C++20 (+12k lines, RAII, lock-free, seccomp-BPF).",
        image: "image/avatar-gpt.png",
        technologies: ["C++20", "eBPF", "XDP", "PBFT", "ONNX", "Linux"],
        demo: "https://github.com/hammoubelyazid",
        repo: "https://github.com/hammoubelyazid",
      },
      {
        title: "OpenToken — Moteur de compression MCP",
        description: "Moteur de filtrage TypeScript optimisé Bun v1.2+ (-55% à -90% tokens via pipeline 35 étapes), compression LZ77/LZW et serveur JSON-RPC MCP pour Cursor, Windsurf & Claude Desktop.",
        image: "image/avatar-gpt.png",
        technologies: ["TypeScript", "Bun", "LZ77", "LZW", "MCP", "JSON-RPC"],
        demo: "https://github.com/hammoubelyazid",
        repo: "https://github.com/hammoubelyazid",
      },
      {
        title: "AEGIS — Defense Active MTD & Intrusions IA",
        description: "Pipeline ML en 8 étapes (SMOTE, XGBoost, Random Forest - 99.91% précision sur CICIDS2017), Moving Target Defense via NFQUEUE, et SOC dashboard Flask/Socket.IO avec capture Scapy live.",
        image: "image/avatar-gpt.png",
        technologies: ["Python", "XGBoost", "NFQUEUE", "Scapy", "Flask", "Socket.IO"],
        demo: "https://github.com/hammoubelyazid",
        repo: "https://github.com/hammoubelyazid",
      },
    ];
